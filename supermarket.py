...
class New_Toplevel:
    ...
    def __init__(self, top=None):
        ...
        font10 = "-family Arial -size 19 -weight normal -slant roman "  \
            "-underline 0 -overstrike 0"
        font11 = "-family Arial -size 18 -weight normal -slant roman "  \
            "-underline 0 -overstrike 0"
        font12 = "-family Arial -size 14 -weight normal -slant roman "  \
            "-underline 0 -overstrike 0"
        font9 = "-family {Hobo Std} -size 9 -weight normal -slant "  \
        ...
        self.Login.configure(command=supermarket_support.checkLogin)
        self.Login.configure(disabledforeground="#a3a3a3")
        self.Login.configure(font=font10)
